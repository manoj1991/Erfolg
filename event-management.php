...
<style>
     .cd-section:nth-of-type(1)>div{
        background-image: linear-gradient(to right bottom, #33ac92, #4db892, #66c492, #7ecf91, #97da90);
    }
    .cd-section:nth-of-type(2)>div{
        background-image: linear-gradient(to left bottom, #97da90, #72b97a, #4f9965, #2d7950, #005b3b);
    }
    .cd-section:nth-of-type(3)>div {
        background-image: linear-gradient(to right bottom, #00954f, #24a96f, #3ebe8e, #59d3ad, #75e7cb);
    }
    .cd-section:nth-of-type(4)>div{
        background-image: linear-gradient(to left bottom, #94b75b, #7baf55, #60a751, #409e4f, #00954f);
    }
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center ">
                        <center>        
                        <h1 class="pm-text">Event Management</h1>                    
                        ...
                        <h1 class="text-center color-white huge-font" >Are you spending more time in micro detailing towards event management than on <br><strong>core objectives of events?</strong> </h1>
