...
<style>
    ...
    .cd-section:nth-of-type(2)>div{
        background-image: linear-gradient(to left bottom, #f28657, #e36d5b, #d05660, #b84263, #9c3365);
    }
    .cd-section:nth-of-type(3)>div {
        background-image: linear-gradient(to right bottom, #9c3365, #a33754, #a54044, #a34b37, #9c572c);
    }
