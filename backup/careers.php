...
<body data-hijacking="on" data-animation="rotate">
            ...
            <div class="container">            
                <div class="row">
                    <div class="col-lg-12 text-center ">
                        ...
                        <h1 class="text-center color-white huge-font" >We work together to create solutions that chart our clients’ success stories. Our people are highly committed to their work and  <br><strong>we look for the same level of commitment in the people who are willing to share our passion for success.</strong> </h1>
            ...
            <div class="container bs-head">  
                <div class="col-md-6">                  
                    ...
                    <p class="desc color-white align-justify bs-head">
                        Taking a cue from Mary Pickford's words 'If you have made mistakes, even serious ones, there is always another chance for you. What we call failure is not the falling down but the staying down', we decided to continue on the journey that we had embarked on and not let a minor upset deter us from the path that we had chosen. The first campaign that Erfolg was to plan and implement did not pan out the way it was visualized and could not deliver the business objectives it was executed for.
                    </p>  
                    <p class="desc color-white align-justify bs-head">
                        Learning our lessons from the dismal start, we set out to build our capabilities that would enable us to deliver successful campaigns. With proper management, serviceability, proven reliability, infrastructure and a team of professionals, we have built a base to put us at par with the best in the industry.
                    </p>              
    ...
    <section class="cd-section ">
        <div>
            <div class="container bs-head">
                <div class="col-md-12">
                    <h3 class="text-center h2">We, at Erfolg, constantly strive to build long-term relationships with our clients and work as partners in business. Anything that is important to you is vital to us.</h3>
                </div>
                <div class="col-md-6 ms-head">
                    <h3 class="h2">One of the characteristics of Erfolg's journey has been the steady approach that we have adopted towards our growth strategy.</h3>
                    <p class="desc color-white  align-justify">The services that we offer have been built over a period of time with the requisite skills being acquired via a strong combination of training by international / national experts and a dedicated in-house capabilities team. Gaining confidence in the belief that it was better to dig one deep well than ten shallow ones, we have worked towards the same.</p>
                </div>
                <div class="col-md-6">
                    <center>
