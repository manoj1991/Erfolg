 ...
 */
(function(t, q) { "function" === typeof define && define.amd ? define([], q) : "object" === typeof module && module.exports ? module.exports = q() : t.anime = q() })(this, function() {
    var t = { duration: 1E3, delay: 0, loop: !1, autoplay: !0, direction: "normal", easing: "easeOutElastic", elasticity: 400, round: !1, begin: void 0, update: void 0, complete: void 0 },
        ...
        C = function() {
            var a = {},
                b = {
                    Sine: function(a) { return 1 + Math.sin(Math.PI / 2 * a - Math.PI / 2) },
                    ...
                    Bounce: function(a) { for (var b, c = 4; a < ((b = Math.pow(2, --c)) - 1) / 11;); return 1 / Math.pow(4, 3 - c) - 7.5625 * Math.pow((3 * b - 2) / 22 - a, 2) }
                };
            ...
            Object.keys(b).forEach(function(c) {
                ...
                a["easeOutIn" + c] = function(a, b) { return .5 > a ? (1 - d(1 - 2 * a, b)) / 2 : (d(2 * a - 1, b) + 1) / 2 }
            });
            a.linear = function(a) { return a };
            return a
        }(),
        y = function(a) { return f.str(a) ? a : a + "" },
        D = function(a) { return a.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase() },
        E = function(a) { if (f.col(a)) return !1; try { return document.querySelectorAll(a) } catch (b) { return !1 } },
        z = function(a) { return a.reduce(function(a, c) { return a.concat(f.arr(c) ? z(c) : c) }, []) },
        r = function(a) {
            if (f.arr(a)) return a;
            f.str(a) && (a = E(a) || a);
            return a instanceof NodeList || a instanceof HTMLCollection ? [].slice.call(a) : [a]
        },
        F = function(a, b) { return a.some(function(a) { return a === b }) },
        Q = function(a, b) {
            var c = {};
        ...
        G = function(a) { return a.filter(function(a, c, d) { return d.indexOf(a) === c }) },
        A = function(a) {
            var b = {},
                c;
            for (c in a) b[c] = a[c];
        ...
        u = function(a, b) { for (var c in b) a[c] = f.und(a[c]) ? b[c] : a[c]; return a },
        R = function(a) {
            a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(a, b, c, l) { return b + b + c + c + l + l });
        ...
        v = function(a, b) { if (b in a.style) return getComputedStyle(a).getPropertyValue(D(b)) || "0" },
        T = function(a, b) {
            var c = -1 < b.indexOf("scale") ? 1 : 0,
                d = a.style.transform;
            if (!d) return c;
            for (var e = /(\w+)\((.+?)\)/g, h = [], l = [], f = []; h = e.exec(d);) l.push(h[1]), f.push(h[2]);
            d = f.filter(function(a, c) { return l[c] === b });
        ...
        U = function(a, b, c) { return b.reduce(function(b, e, h) { e = e ? e : c[h - 1]; return b + a[h - 1] + e }) },
        V = function(a) { a = a ? z(f.arr(a) ? a.map(r) : r(a)) : []; return a.map(function(a, c) { return { target: a, id: c } }) },
        M = function(a, b, c, d) { "transform" === c ? (c = a + "(" + H(a, b.from, b.to) + ")", b = a + "(" + H(a, b.to) + ")") : (a = "css" === c ? v(d, a) : void 0, c = K(b, b.from, a), b = K(b, b.to, a)); return { from: L(c), to: L(b) } },
        W = function(a, b) {
            var c = [];
        ...
        Y = function(a) { return Math.max.apply(Math, a.map(function(a) { return a.totalDuration })) },
        Z = function(a) { return Math.min.apply(Math, a.map(function(a) { return a.delay })) },
        N = function(a) {
            var b = [],
                c = [];
            a.tweens.forEach(function(a) {
                if ("css" === a.type ||
                    "transform" === a.type) b.push("css" === a.type ? D(a.name) : "transform"), a.animatables.forEach(function(a) { c.push(a.target) })
            });
        ...
        ba = function(a) { N(a).elements.forEach(function(a) { a.style.removeProperty("will-change") }) },
        ca = function(a, b) {
            var c = a.path,
                d = a.value * b,
                e = function(e) { e = e || 0; return c.getPointAtLength(1 < b ? a.value + e : d + e) },
                h = e(),
                f = e(-1),
                e = e(1);
            switch (a.name) {
        ...
        w = 0,
        ea = function() {
            var a = function() { w = requestAnimationFrame(b) },
                b = function(b) {
                    if (n.length) {
        ...
        k = function(a) {
            ...
            b.seek = function(a) { O(b, a / 100 * b.duration) };
            b.pause = function() {
                ba(b);
                var a = n.indexOf(b); - 1 <
                    a && n.splice(a, 1)
    ...
    k.easings = C;
    k.getValue = J;
    k.path = function(a) { a = f.str(a) ? E(a)[0] : a; return { path: a, value: a.getTotalLength() } };
