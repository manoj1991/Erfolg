...
<style>
     .cd-section:nth-of-type(1)>div{
        background-image: linear-gradient(to right bottom, #ff7189, #ff8476, #ff9c64, #ffb658, #ffd155);
    }
    .cd-section:nth-of-type(2)>div{
        background-image: linear-gradient(to left bottom, #ffa361, #ff817a, #ff67a5, #db67d7, #7679ff);
    }
    .cd-section:nth-of-type(3)>div {
        background-image: linear-gradient(to right bottom, #008aff, #b56eeb, #fd46b2, #ff3f66, #ff6b00);
    }
    .cd-section:nth-of-type(4)>div{
        background-image: linear-gradient(to left bottom, #bf3300, #de2b68, #cb5dbd, #888ef3, #00b3ff);
    }
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center ">
                        ...
                        <h1 class="text-center color-white h3" >Is your marketing team constraint for time and <br>missing deadlines?</h1>
    ...
    <section class="cd-section bs-carousel">
        <div>
            <div class="container">
                <div class="col-md-12">
                    <center>   
                        <h1 class="line-height bs-head-txt-5 color-white align-justify  bs-head-2">The Projects team at Erfolg is also strengthened by the presence of campaign planners & analysts.</h1>
                    </center>
                </div>
                <div class="col-md-12">                    
                    <center>
