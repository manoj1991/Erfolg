...
<?php include "nav.php"; ?>
    ...
    <section id="about" class="about ">
       <div class="container">
           <h1 class="text-center">Are you able to reach your prospects <br><b>early in the sales cycle?</b> </h1>
       </div>
        <!-- /.container -->
    </section>
    ...
    <section id="services" class="services ">
       <div class="container-fluid">         
        ...
                            <li role="presentation" class="active"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab"><h1>Challenges</h1></a></li>
                            <li role="presentation"><a href="#Section2" aria-controls="profile" role="tab" data-toggle="tab"><h1>ROI</h1></a></li>
                            <li role="presentation"><a href="#Section3" aria-controls="settings" role="tab" data-toggle="tab"></i><h1>Role</h1></a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="Section1">                                    
                                <p class="desc">One of the challenges facing any marketing team is the support that can be extended to the sales function – the direct &amp; indirect impact to the revenue generation for the organization. Therefore, it becomes essential to support an engine like lead management that would have the capability of working on various marketing responses &amp; databases and substantiate the market coverage for the various sales teams. </p>
                                <p class="desc"><i>Erfolg</i> has developed and successfully deployed a very effective methodology via tele-prospecting for qualifying marketing leads from the expansive target audience. Our teams with well-equipped skill-sets and training are not only able to understand the needs of the prospects but are also able to have discussions around the challenges driving the need along with the fitment of the pitched products / services to the prospects' organizational set-ups.</p>
                            </div>
         
                            <div role="tabpanel" class="tab-pane fade" id="Section2">                                    
                                <p class="desc">Any campaign generates immediate as well as future returns and effectiveness of any lead management team is defined on the potential to define the time frame of the requirements accurately. Along with aiding the sales team to extend the market coverage, the pipeline management team has to be able to ascertain that the qualified marketing leads are added to the funnel of the sales teams only at the appropriate time – the key task is to enhance the funnel &amp; not clutter the same with leads with requirements at a later date. The team at <i>Erfolg</i> is trained on techniques in lead nurturing with extended time frame so as to keep the continuity of discussion alive with the prospects with multi-touch marketing aids like product guides, whitepapers and other direct marketing techniques by implementing CRM solutions. The lead nurturing mechanism helps reduce unwanted connects with the prospects for confirmation of the same requirement multiple times &amp; also, ensures that the opportunities are not lost in transition from the opportunity discovery to the sales. </p>
                            </div>
         
                            <div role="tabpanel" class="tab-pane fade" id="Section3">                                    
                                <p class="desc">Our tele-prospecting teams leverage on the repository by undertaking cold calling to relevant organizations not covered by the marketing databases to widen the reach &amp; also to augment the number of qualified sales leads. They are not constraint by a particular approach as per a single marketing campaign but their experience enables them to initiate connects with ease with cold suspects also. The diversity of skills of the teams at <i>Erfolg</i> facilitates in offering structured &amp; customized programs that guarantee ROI for any lead generation activity</p>
                            </div>
                        </div>
                    </div>
                </div>
