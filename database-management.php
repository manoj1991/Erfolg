...
<style>
    .cd-section:nth-of-type(1)>div{
        background-image: linear-gradient(to right bottom, #441846, #404984, #007bb7, #00aed3, #00dfd8);
    }
    .cd-section:nth-of-type(2)>div{
        background-image: linear-gradient(to left bottom, #00b8d7, #009ac9, #207bb4, #385d99, #443f79);
    }
    .cd-section:nth-of-type(3)>div {
        background-image: linear-gradient(to right bottom, #441846, #444c89, #0082c0, #00b9e1, #00efe8);
    }
    .cd-section:nth-of-type(4)>div{
        background-image: linear-gradient(to left bottom, #00ada8, #008fae, #006da2, #444a82, #532654);
    }
    .cd-section:nth-of-type(5)>div{
        background-image: linear-gradient(to right bottom, #982667, #9e4892, #9b68bc, #8f88e1, #7ca7ff);
    }
    ...
    <section class="cd-section bs-carousel">
        <div>
            <div class="container">
                <div class="col-md-12">
                    <center>   
                        <h1 class="line-height bs-head-txt-5 color-white align-justify  bs-head-2">
                ...
                <div class="col-md-12 ">
                    ...
                    <h3 class="text-center">We specialize in the following:</h3>
                            ...
                            <div class="carousel-inner ">                               
                                <div class="item active">                                
                                    <div class="carousel-caption">                                      
                                        <p class="pm-slider"><br><br><br><strong>Data Procurement/Sourcing:</strong> We specialize in data sourcing and can source any B to B database not limited to geography, vertical, roles, profiles, information, records, etc.</p>
                                    </div>
                                </div>

                                <div class="item">
                                    <div class="carousel-caption">                                        
                                        <p class="pm-slider"><br><br><strong>Data Cleansing:</strong> In data cleansing, we ensure that the data is de-duped and kept relevant at all times. Majority of the times, the record size is massive but however, because of duplication, the actual size shrinks. Hence, the team ensures that database is clean & formatted to reflect actual contacts.</p>
                                    </div>
                                </div>
                                
                                <div class="item">                                
                                    <div class="carousel-caption">                                        
                                        <p class="pm-slider"><br><br><strong>Data Segmentation/Standardization:</strong> Databases are vast and for creating any marketing campaigns, it is vital that some filters are applied towards effective planning. Therefore, our data team ensures that there are standardization of terms especially in terms of vertical, size, turnover, job roles, geographies, etc.</p>
                                    </div>
                                </div>

                                <div class="item">                                
                                    <div class="carousel-caption">                                        
                                        <p class="pm-slider"><strong>Data Profiling:</strong> Basic Database information at times is related to contact information and a couple of other parameters like industry, region, etc. However, when any marketer has to plan for any strategic & niche campaign, faced with the task of further defining the target in terms of applicability of solution, etc, they are forced to give up on the campaign or go broad (Hit-and-miss strategy). Our data team has worked to create a profiled database on multiple parameters.</p>
                                    </div>
                                </div>

                                <div class="item">                                
                                    <div class="carousel-caption">                                        
                                        <p class="pm-slider"><br><strong>Data Verification/Validation:</strong> Data Validation is a process that is undertaken to ensure that all records are live at all times, the tele-calling team at our end will connect with the contacts to verify the information captured at our end is updated and correct or not? We suggest and undertake this every six months to ensure validity of the data as the churn in organizations is high these days.</p>
                                    </div>
                                </div>

                                <div class="item">                                
                                    <div class="carousel-caption">                                        
                                        <p class="pm-slider"><br><strong>Data Enhancement:</strong> It is a process where we are provided with some information and there has to additions done to the same in terms of sourcing alternate contacts or job titles in the organizations or else email ids or phone numbers, etc. Data Enhancement is where we work on some information at our end, need to add certain information for further use. Data Procurement/Sourcing</p>
                                    </div>
                                </div>
